...
images = [
    ...
    './questions_images/placeholder.jpg',
...
async def printQuestion(callback, message, user_id):
    ...
    await message.answer_photo(InputFile(images[question_idx])) # путь до placeholder'a (здесь могла быть ваша реклама), если ,будут все фотки для вопросов, то заменить на images[question_idx]
